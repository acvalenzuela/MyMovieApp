...
async function analyzeSize(queueFunction, project) {
    ...
    await (0, utilities_1.showProgress)('Generating Project Statistics', async () => {
        ...
        try {
            ...
            (0, logging_1.writeWN)('Building for production with Sourcemaps...');
            let args = '';
            if (project.repoType == monorepo_1.MonoRepoType.nx || project.frameworkType.startsWith('angular')) {
                args = '--configuration=production';
            }
            const cmd = await (0, build_1.build)(project, { arguments: args, sourceMaps: true });
            ...
            (0, logging_1.writeWN)('Analyzing Sourcemaps...');
            ...
            (0, logging_1.writeWN)('Launched project statistics window.');
        }
        finally {
            ...
            for (const prj of Object.keys(projects)) {
                ...
                if ((_b = (_a = cfg.build) === null || _a === void 0 ? void 0 : _a.configurations) === null || _b === void 0 ? void 0 : _b.production) {
                    ...
                    if (previousValue == true) {
                        ...
                        (0, logging_1.writeWN)(`Temporarily modified production sourceMap of ${prj} to true in angular.json`);
                        changeMade = true;
                    }
                }
            }
